...
public class AdminDashBoardController {
    ...
    Pattern addPackSizePattern = Pattern.compile("^[1-9]+$");
    Pattern addUnitPricePattern = Pattern.compile("^[0-9]+[.]?[0-9]{2}$");
    Pattern addQTYOnHandPattern = Pattern.compile("^[1-9]+$");
    Pattern addDescriptionPattern = Pattern.compile("^[A-z0-9 &,]{3,}$");
    Pattern addDiscountPattern = Pattern.compile("^[0-9]+[.]?[0-9]{2}$");
    ...
    public void initialize() throws SQLException, ClassNotFoundException {
        ...
        customer = customerBO.getAllCustomer();
        item = itemBO.getAllItems();
    ...
    private void storeValidations1() {
        map.put(txtPackSize1, addPackSizePattern);
        map.put(txtUnitPrice1, addUnitPricePattern);
        map.put(txtQTYOnHand1, addQTYOnHandPattern);
        map.put(txtDescription1, addDescriptionPattern);
        map.put(txtDiscount1, addDiscountPattern);
    }
    ...
    public void addItemOnAction(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        if(!txtDescription1.getText().equals("") && !txtDiscount1.getText().equals("") && !txtPackSize1.getText().equals("") && !txtQTYOnHand1.getText().equals("") && !txtUnitPrice1.getText().equals("")){
            ItemDTO item = new ItemDTO(lblItemCode1.getText(),txtDescription1.getText(),txtPackSize1.getText(),Double.parseDouble(txtUnitPrice1.getText()), Integer.parseInt(txtQTYOnHand1.getText()),Double.parseDouble(txtDiscount1.getText()));
    ...
    public void searchItemOnAction1(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        ...
        ItemDTO item = new ItemDAOImpl().getItem(itemCode);
        if(item==null){
    ...
    public void updateOnAction(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        if (!txtDescription2.getText().equals("") && !txtDiscount2.getText().equals("") && !txtPackSize2.getText().equals("") && !txtQTYOnHand2.getText().equals("") && !txtUnitPrice2.getText().equals("")) {
            ItemDTO item = new ItemDTO(lblItemCode2.getText(),txtDescription2.getText(),txtPackSize2.getText(),Double.parseDouble(txtUnitPrice2.getText()), Integer.parseInt(txtQTYOnHand2.getText()),Double.parseDouble(txtDiscount2.getText()));
    ...
    public void deleteOnAction(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        if (new ItemDAOImpl().delete(lblItemCode3.getText())){
    ...
    public void textFieldsForAdd_key_Released(KeyEvent keyEvent) {
        Object response = ValidationUtil.validateForNormalTextFields(map,btnAddItem);
