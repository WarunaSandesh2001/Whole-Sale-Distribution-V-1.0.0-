...
public class OrderSavedFormController {
    ...
    public void initialize() throws SQLException, ClassNotFoundException {
        ...
        setOrderIdAndNicToTable(purchaseOrderBO.getAllOrderIDSWithNIC());
        ...
        cmbItemDescription.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> {
            try {
                ItemDTO item = purchaseOrderBO.search(newValue);
        ...
        cmbOrderID.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> {
            try {
                ...
                nic = purchaseOrderBO.getNIC(newValue);
                CustomerDTO cust = purchaseOrderBO.getCustomer(nic);
    ...
    private void setItemsToTable(String newValue) throws SQLException, ClassNotFoundException {
        ArrayList<SavedOrderDetailsTM> s = purchaseOrderBO.getOrderDetails(newValue,lblNIC);
        s.forEach(e->{
    ...
    public void addToCartOnAction(ActionEvent actionEvent) {
       if (!txtQTYForSell.getText().equals("") ) {
            try {
                ...
                ItemDTO item = purchaseOrderBO.search(cmbItemDescription.getSelectionModel().getSelectedItem());
    ...
    public void UpdateOnAction(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        if (cartSelectedRow==-1){
            ...
            ItemDTO i = purchaseOrderBO.getItem(c.getItemCode());
    ...
    public void cancelOrderOnAction(ActionEvent actionEvent) throws SQLException, ClassNotFoundException, IOException {
        if(purchaseOrderBO.deleteOrderFromSavedOrderTable(cmbOrderID.getSelectionModel().getSelectedItem())){
    ...
    public void placeOrderOnAction(ActionEvent actionEvent) throws SQLException, ClassNotFoundException, IOException {
        ...
        if(purchaseOrderBO.saveOrderToDBTable(d)){}
            purchaseOrderBO.saveOrderToOrderDetailTable(cmbOrderID.getSelectionModel().getSelectedItem(),obList);
            purchaseOrderBO.updateItemTable(obList);
        if(purchaseOrderBO.deleteOrderFromSavedOrderTable(cmbOrderID.getSelectionModel().getSelectedItem())){
            URL resource = getClass().getResource("../view/OrderSavedForm.fxml");
            Parent load = FXMLLoader.load(resource);
            savedFormContext.getChildren().clear();
